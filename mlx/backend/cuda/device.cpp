...
#ifdef _WIN32
  // CUDA graphs have issues on Windows with parameter passing.
  // Disable by default on Windows until resolved.
  static bool use_graphs = env::get_var("MLX_USE_CUDA_GRAPHS", false);
#else
